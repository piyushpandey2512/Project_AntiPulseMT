...
public:
  ...
  void SetHadGratingCollision(bool val) {
    fHadAntiprotonSiliconCollision = val;
  }
...
private:
  ...
  //   momentum
  std::map<const G4Track *, std::map<G4int, G4ThreeVector>>
      fIntraModuleMomentumMap;
